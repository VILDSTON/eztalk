...
export const AddFriendModal: React.FC<AddFriendModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center glass-overlay animate-fade-in select-none p-4">
      <div className="bg-ez-elevated border border-ez-border rounded-3xl w-full max-w-md p-6 shadow-glass-lg relative">
        {/* Header */}
        <div className="flex items-center justify-between pb-4 border-b border-ez-border/50">
        ...
        {/* Error Alert */}
        {errorMessage && (
          <div className="mt-4 flex items-center space-x-2 bg-red-500/10 border border-red-500/25 p-2.5 rounded-xl text-red-400 text-xs animate-fade-in">
